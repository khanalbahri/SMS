...
function AllTeachers() {
  ...
  const columns = [
    { title: "Name", field: "teacherName" ,filtering:false,},
    { title: "Qualification", field: "qualification",filtering:false, },
          ...
          actions={[
            {
              icon: MoreSharpIcon,
              tooltip: 'Save User',
              onClick: (event, rowData) => window.location = `/teacher/teacherDetails/${rowData._id}`
            }
          ]}
