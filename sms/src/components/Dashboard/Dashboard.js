...
export default function Dashboard() {
    ...
    const logout = () => {
        dispatch(logoutFunc(setUser,history));
    }
        ...
        <div className={classes.root}>
            ...
            <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
                <Toolbar className={classes.toolbar}>
                    ...
                    <Avatar alt="user Image" src={`${URL}${user?.result.userImage}`}>{user?.result?.userName?.charAt(0)}</Avatar>
                    ...
                    <span>
                        ...
                        <Typography onClick={logout} style={{ textDecoration: "none", marginLeft: "8px", marginRight: "8px" }} component={Link} to="/authentication" variant="h6" color="inherit" noWrap className={classes.title}>
                            Logout
                        </Typography>
                    </span>
                </Toolbar>
